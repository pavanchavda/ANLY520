...
- Top terms for each of the positive topics. 
...
The above visualization reveals that Topic 0 contains 52% of the tokens in the dataset. It includes words like the airline names, "thanks", "not", and "good". Further exploration of the topics through the topic visualization above reveals more terms like "great", "customer", "service" and "flight" suggesting that this topic is most likely related to great customer service. 

A similar examination of the above terms and visualization shows that Topic 1 contains 39.6% of the tokens, and it includes words like "thank", "flight", "you" and "great" suggesting that this topic may also be related to customer experience in relation to flights. Further analysis may be required to clearly delineate these topics. 

Topic 2 contains only 8.5% of the tokens, and it includes a mix of positive and neutral words like "gate", "agent", "airport", "tonight", "nice", "warm" and "seat", and traditionally negative words like "cancelled" and "problems" suggesting that this topic may be related to customer experience during problem resolution conversations with agents and other airlines staff.
...
Topic 0 contains 75.3% of the tokens, and it includes words like "customer", "plane", "service", "gate" and "agent" suggesting that this topic may be related to customer service.

Topic 1 is made up of 21.8% of the tokens, and it includes words like "not", "flight", "no", "get" and "cancelled" suggesting that this topic may be related to cancelled flights. 

Finally, Topic 2, which consists a mere 2.9% of the tokens, includes words like "seat", "broken", "legroom", "club" and "sell" suggesting that this topic may be related to seating comfort.
